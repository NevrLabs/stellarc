...
The browser cached every layout but did not distinguish a Axis-acknowledged cache from an unsynced write. A successful project GET therefore replaced the cache after a failed PUT.
