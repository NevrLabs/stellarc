...
export const MessageContent = ({ className, bubble, ...props }: HTMLAttributes<HTMLDivElement> & { bubble?: boolean }) =>
  bubble ? <div className={cn("msg-bubble", className)} {...props} /> : <>{props.children}</>;
