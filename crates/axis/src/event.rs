...
//!
//! See `docs/plans/2026-06-28-stellarc-mvp.md` Task 1.1 for the exact spec.
...
pub enum Event {
    ...
    SessionCreated {
        ...
        input_tokens: u64,
        output_tokens: u64,
        /// Agent (Hermes profile) bound to this session, if any. Stellarc-created
    ...
    /// replicable unit: skills/mcp/plugins/hooks the orbit must materialize into
    ...
    /// Assigns or narrows a Axis-signed capability envelope for a session.
    ...
    fn all_event_variant_instances() -> Vec<Event> {
        vec![
            ...
            Event::JobOutputPersisted {
                ...
                attempt_epoch: 1,
                seq: 0,
                stream: stellarc_proto::frames::JobStream::Stdout,
                data: "ok".into(),
                persisted_at: 2.0,
            },
            Event::JobTerminal {
