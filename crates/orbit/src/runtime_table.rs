//! Per-session runtime table — the orbit-side half of the old monolith
...
//! backfill) stays axis-side; the axis calls into this table through the
//! factory seam.
...
use stellarc_proto::RuntimeSpec;

/// A type-erased runtime factory. Production uses HermesAgentRuntime; tests
/// inject a mock. The optional session id lets the production Orbit
...
pub struct RuntimeTable {
    ...
    /// Active runtimes keyed by Stellarc session id.
